...
export const { openRowCardWithMoreDetails, closeRowCardWithMoreDetails} = rowCardWithMoreDetailsSlice.actions;
export const selectRowCardWithMoreDetails = (state) => state.rowCardWithMoreDetails.value;
